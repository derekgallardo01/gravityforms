...
class GFFormsModel {
	...
	public static function get_lead_notes_archive_dir($lead_id){
        ...
        return $wpdb->get_results($wpdb->prepare("  SELECT n.id, n.user_id, n.date_created, n.value, n.archive, n.archive_dir FROM $notes_table n WHERE lead_id=%d and archive = 1 ORDER BY id", $lead_id));
    }
		...
		return $wpdb->get_results(
			$wpdb->prepare(
				"  SELECT n.id, n.user_id, n.date_created, n.value, n.note_type, n.sub_type, ifnull(u.display_name,n.user_name) as user_name, u.user_email
                                                    ...
                                                    WHERE (n.archive is null or n.archive = '') and entry_id=%d ORDER BY id", $lead_id
			)
		);
	}
